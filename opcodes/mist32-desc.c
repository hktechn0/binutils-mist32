...
/* umull $rd,$rs */
  {
    MIST32_INSN_UMULL, "umull", "umull", 32,
    { 0, { { { (1<<MACH_BASE), 0 } } } }
  },
/* umull $rd,$ui11 */
  {
    MIST32_INSN_UMULLI, "umulli", "umull", 32,
    { 0, { { { (1<<MACH_BASE), 0 } } } }
  },
/* umulh $rd,$rs */
  {
    MIST32_INSN_UMULH, "umulh", "umulh", 32,
    { 0, { { { (1<<MACH_BASE), 0 } } } }
  },
/* umulh $rd,$ui11 */
  {
    MIST32_INSN_UMULHI, "umulhi", "umulh", 32,
    { 0, { { { (1<<MACH_BASE), 0 } } } }
  },
/* addc $rd,$rs */
  {
...
/* srfi0r $rd */
  {
    MIST32_INSN_SRFI0R, "srfi0r", "srfi0r", 32,
    { 0, { { { (1<<MACH_BASE), 0 } } } }
  },
/* srfi1r $rd */
  {
    MIST32_INSN_SRFI1R, "srfi1r", "srfi1r", 32,
    { 0, { { { (1<<MACH_BASE), 0 } } } }
  },
/* srspw $rd */
  {
